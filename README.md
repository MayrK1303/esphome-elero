...
### Section cover
  ...
  * `command_stop_up`: Override the release command after an upward long-drive press (Optional)
  * `command_stop_down`: Override the release command after a downward long-drive press (Optional)
