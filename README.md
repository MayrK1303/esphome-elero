...
### Section cover
  ...
  * `command_stop_up`: Override the release command after upward timed tilt movement (Optional)
  * `command_stop_down`: Override the release command after downward timed tilt movement (Optional)
