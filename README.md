...
### Section cover
  ...
  * `command_stop_up`: Override the release command after an upward press or timed tilt (Optional)
  * `command_stop_down`: Override the release command after a downward press or timed tilt (Optional)
